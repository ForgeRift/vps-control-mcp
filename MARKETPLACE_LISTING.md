...
**License:** MIT. Full source at [github.com/ForgeRift/vps-control-mcp](https://github.com/ForgeRift/vps-control-mcp).
...
| `LAYER_STRICT_MODE` | `true` | When `false`, Layer 2/3 infrastructure failures silently skip AI review instead of failing closed. Disabling removes the fail-safe on classifier unavailability; use only in environments where the AI review endpoint is unreliable and you accept the reduced security posture. |
