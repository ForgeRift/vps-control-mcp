...
This is the current list of known limitations and caveats for vps-control-mcp. We keep it honest and current. If you hit something that isn't here, open a [GitHub issue](https://github.com/forgerift/vps-control-mcp/issues) and we'll add it.
...
3. Report the specific prompt and Claude's response to [GitHub issues](https://github.com/forgerift/vps-control-mcp/issues) — real examples are how we sharpen the rules
...
File at: https://github.com/forgerift/vps-control-mcp/issues
